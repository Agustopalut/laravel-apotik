        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <input type="text" name="name" id="fullname__"
              class="form-input" style="background-image: url('./assets/svgs/ic-profile.svg')" placeholder="Write your full name">
          </div>
          <!-- Email Address -->
          <div class="flex flex-col gap-2.5">
            <label for="email" class="text-base font-semibold">Email Address</label>
            <input type="email" name="email" id="email__"
              class="form-input" style="background-image: url('./assets/svgs/ic-email.svg')" placeholder="Your email address">
          </div>
          <!-- Password -->
          <div class="flex flex-col gap-2.5">
            <label for="password" class="text-base font-semibold">Password</label>
            <input type="password" name="password" id="password__"
              class="form-input" style="background-image: url('./assets/svgs/ic-lock.svg')" placeholder="Protect your password">
          </div>
          <!-- Confirm Password -->
          <div class="flex flex-col gap-2.5">
