        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <input type="email" name="email" id="email__"
              class="form-input" placeholder="Your email address" style="background-image: url('./assets/svgs/ic-email.svg')">
          </div>
          <!-- Password -->
          <div class="flex flex-col gap-2.5">
            <label for="password" class="text-base font-semibold">Password</label>
            <input type="password" name="password" id="password__"
              class="form-input" placeholder="Protect your password" style="background-image: url('./assets/svgs/ic-lock.svg')">
          </div>
